  ...
  public  class ProductService
    {
        ...
        public async Task<IEnumerable<ProductModel>> GetAsync()
        {
            ...
            {
                return ProductModel.DeserializeObject<IEnumerable<ProductModel>>(data);
            }
            else
            {
        ...
        public async Task<ProductModel> GetAsync(int id)
        {
            ...
            if (response.IsSuccessStatusCode)
            {
                return ProductModel.DeserializeObject<ProductModel>(data);
            }
        ...
        public async Task<ProductModel> CreateAsync(ProductModel product, byte[] photo)
        {
            ...
            (
                ProductModel.SerializeObject(product),
            ...
            {
                throw new DuplicateWaitObjectException($"Product code {product.Reference} already exists !");
            }
            else
            {
                throw new Exception($"Error status code : {response.StatusCode} \n {data}");
